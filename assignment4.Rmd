...
```{r}
D1 <- data.frame(Assistments_confidence)
...
library("corrplot", lib.loc="C:/Program Files/R/R-3.4.1/library")
...
tl.col="black", tl.cex=1, tl.srt=45, 
        addCoef.col="red", addCoefasPercent = TRUE,
        sig.level=0.80, insig = "blank")
...
#the ones that don't tell us anything. In this case, that would be 6?
...
#So I dropped PC3,4 and 5 and the mean correct did not change at all. PC3, 4 and 5 seemed to have a negligable affect and therefore, no we didn't loase any important information about the mean_correct.

D5 <- dplyr::select(D4,1:2,6:7)
COR2 <- cor(D4)
COR3 <- cor(D5)

corrplot(COR2, order="AOE", method="circle", tl.pos="lt", type="upper",        
tl.col="black", tl.cex=1, tl.srt=45, 
        addCoef.col="purple", addCoefasPercent = TRUE,
        sig.level=0.80, insig = "blank")
